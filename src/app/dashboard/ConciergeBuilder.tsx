                ...
                <div className="p-4 bg-white border-t border-zinc-100">
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 bg-zinc-50 border border-zinc-200 rounded-lg px-4 py-2 text-base lg:text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
